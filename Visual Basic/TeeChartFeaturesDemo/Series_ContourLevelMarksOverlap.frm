...
Begin VB.Form Series_ContourLevelMarksOverlap 
   BorderStyle     =   0  'None
   Caption         =   "Form2"
   ClientHeight    =   6915
   ClientLeft      =   3480
   ...
   Begin TeeChart.TChart TChart1 
      ...
      Top             =   1650
      Width           =   11505
      Base64          =   $"Series_ContourLevelMarksOverlap.frx":0000
   End
   Begin VB.TextBox Text1 
      ...
      MultiLine       =   -1  'True
      TabIndex        =   0
      Text            =   "Series_ContourLevelMarksOverlap.frx":D29A
      Top             =   0
      Width           =   11490
   End
   ...
   End
End
Attribute VB_Name = "Series_ContourLevelMarksOverlap"
...
Private Sub Check3_Click()
  TChart1.Series(0).asContour.ContourMarks.AntiOverlap = Check3.Value
End Sub
